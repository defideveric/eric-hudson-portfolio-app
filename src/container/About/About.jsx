...
const abouts =[ 
  ...
  { title: 'Javascript | React', description: 'I am a good web developer', imgUrl: images.about03},
  { title: 'UI Design', description: 'I am a good web developer', imgUrl: images.about04}
]
const About = () => {
  return (
    <>
